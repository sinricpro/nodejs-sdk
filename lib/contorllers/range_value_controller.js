...
const RangeValue = (payload, callbacks) => {
  ...
  callbacks.setRangeValue(payload.deviceId, sinricProData.rangeValue);
  return new Promise((resolve, reject) => {
    if (payload.value.rangeValue) resolve(payload.value);
...
const RangeValueAdjust = (payload, callbacks) => {
  ...
  callbacks.adjustRangeValue(payload.deviceId, sinricProData.rangeValue);
  return new Promise((resolve, reject) => {
    if (payload.value.rangeValueDelta) resolve({ rangeValue: sinricProData.rangeValue });
